...
varImp(ufc_rf_final)
# Threshold 10
# If 2/3 rounds have feature with >10, then that feature will be included

# Selecting columns that satisfy the criteria
new_df <- df[c('sig_str_rnd_1', 'sig_str_attempt_rnd_1', 'tot_str_rnd_1',
               'tot_str_attempt_rnd_1','td_rnd_1', 'ctrl_time_rnd_1',
               'sig_str_rnd_2', 'sig_str_attempt_rnd_2', 'tot_str_rnd_2',
               'tot_str_attempt_rnd_2', 'td_rnd_2', 'ctrl_time_rnd_2',
               'sig_str_rnd_3', 'sig_str_attempt_rnd_3', 'tot_str_rnd_3',
               'tot_str_attempt_rnd_3', 'td_rnd_3', 'ctrl_time_rnd_3',
               'sig_str_head_rnd_1', 'sig_str_head_attempt_rnd_1',
               'sig_str_dist_rnd_1', 'sig_str_gnd_rnd_1',
               'sig_str_gnd_attempt_rnd_1',
               'sig_str_head_rnd_2', 'sig_str_head_attempt_rnd_2', 
               'sig_str_dist_rnd_2', 'sig_str_gnd_rnd_2', 
               'sig_str_gnd_attempt_rnd_2',
               'sig_str_head_rnd_3', 'sig_str_head_attempt_rnd_3', 
               'sig_str_dist_rnd_3', 'sig_str_gnd_rnd_3', 
               'sig_str_gnd_attempt_rnd_3'
               )]
write.csv(new_df, 'ufcstats_from_combined_columns.csv', row.names = FALSE)

# Export metrics to the csv to use it in the presentation/report.
all_metrics_t <- t(as.data.frame(all_metrics))
write.csv(all_metrics_t, file = "final_metrics_combined_columns.csv", sep = ",")
